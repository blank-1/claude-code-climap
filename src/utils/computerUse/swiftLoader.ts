import type { ComputerUseAPI } from 'computer-use-swift'
...
export function requireComputerUseSwift(): ComputerUseAPI {
  if (process.platform !== 'darwin') {
    throw new Error('computer-use-swift is macOS-only')
  }
  // eslint-disable-next-line @typescript-eslint/no-require-imports
  return (cached ??= require('computer-use-swift') as ComputerUseAPI)
}
